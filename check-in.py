...
def Janela_eng():
    ...
    def btn_capacete():
        ...
        sql = 'INSERT INTO entrada_cap_epi(id_cap, nome_epi_cap, nome_fun_cap, func_cap) VALUES (?, ?, ?, ?)'
    ...
    def btn_colete():
        ...
        sql = 'INSERT INTO entrada_col_epi(id_col, nome_epi_col, nome_fun_col, func_col) VALUES (?, ?, ?, ?)'
    ...
    def btn_oculos():
        ...
        sql = 'INSERT INTO entrada_ocu_epi(id_ocu, nome_epi_ocu, nome_fun_ocu, func_ocu) VALUES (?, ?, ?, ?)'
    ...
    def btn_luva():
        ...
        sql = 'INSERT INTO entrada_luva_epi(id_luva, nome_epi_luva, nome_fun_luva, func_luva) VALUES (?, ?, ?, ?)'
    ...
    background_eng = PhotoImage(file = f"Imagens/eng/background.png")
    background = canvas.create_image(
        475.0, 267.0,
        image=background_eng)

    img0 = PhotoImage(file = f"Imagens/eng/img0.png")
    ...
    img1 = PhotoImage( file = f"Imagens/eng/img1.png")
    ...
    img2 = PhotoImage( file = f"Imagens/eng/img2.png")
    ...
    img3 = PhotoImage( file = f"Imagens/eng/img3.png")
    ...
    img4 = PhotoImage( file = f"Imagens/eng/img4.png")
...
def Janela_ele():
    ...
    def btn_cinturao():
        ...
        con = sqlite3.connect('banco.sqlite')
        cur = con.cursor()
        sql = 'INSERT INTO entrada_cin_epi(id_cin, nome_epi_cin, nome_fun_cin, func_cin) VALUES (?, ?, ?, ?)'
    ...
    background_img = PhotoImage(file = f"Imagens/ele/background.png")
    background = canvas.create_image(
        475.0, 267.0,
        image=background_img)

    img0 = PhotoImage(file = f"Imagens/ele/img0.png")
    ...
    img1 = PhotoImage(file = f"Imagens/ele/img1.png")
    ...
    img2 = PhotoImage(file = f"Imagens/ele/img2.png")
    ...
    img3 = PhotoImage(file = f"Imagens/ele/img3.png")
    ...
    img4 = PhotoImage(file = f"Imagens/ele/img4.png")
    ...
    img5 = PhotoImage(file = f"Imagens/ele/img5.png")
...
def Janela_ped():
    ...
    background_img = PhotoImage( file = f"Imagens/ped/background.png")
    background = canvas.create_image(
        475.0, 267.0,
        image=background_img)

    img0 = PhotoImage(file = f"Imagens/ped/img0.png")
    ...
    img1 = PhotoImage( file = f"Imagens/ped/img1.png")
    ...
    img2 = PhotoImage( file = f"Imagens/ped/img2.png")
    ...
    img3 = PhotoImage( file = f"Imagens/ped/img3.png")
    ...
    img4 = PhotoImage( file = f"Imagens/ped/img4.png")
...
def Janela_pin():
    ...
    def btn_mascara():
        ...
        con = sqlite3.connect('banco.sqlite')
        cur = con.cursor()
        sql = 'INSERT INTO entrada_masc_epi(id_masc, nome_epi_masc, nome_fun_masc, func_masc) VALUES (?, ?, ?, ?)'
    ...
    background_img = PhotoImage(file = f"Imagens/pin/background.png")
    background = canvas.create_image(
        475.0, 267.0,
        image=background_img)

    img0 = PhotoImage(file = f"Imagens/pin/img0.png")
    ...
    img1 = PhotoImage(file = f"Imagens/pin/img1.png")
    ...
    img2 = PhotoImage(file = f"Imagens/pin/img2.png")
    ...
    img3 = PhotoImage(file = f"Imagens/pin/img3.png")
    ...
    img4 = PhotoImage(file = f"Imagens/pin/img4.png")
    ...
    img5 = PhotoImage(file = f"Imagens/pin/img5.png")
...
def check():
    ...
    con = sqlite3.connect('banco.sqlite')
    cur = con.cursor()
    sql = 'INSERT INTO entrada_fun(id_fun, nome_fun, func_fun) VALUES (?,?,?)'
...
background_img = PhotoImage(file = f"Imagens/check-in/background.png")
background = canvas.create_image(
    475.0, 267.0,
    image=background_img)

img0 = PhotoImage(file = f"Imagens/check-in/img.ck.png")
b0 = Button(
    image = img0,
    borderwidth = 0,
    highlightthickness = 0,
